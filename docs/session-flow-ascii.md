...
- On resume, refinement continues only if memory exists and the current branch has a valid cursor. If an older session has no refinement files, the extension warns you and offers to rebuild it.
